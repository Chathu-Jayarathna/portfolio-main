  ...
  return (
    <section className="w-full py-1">
      <h1 className="heading">
        What <span className="text-purple">I Do</span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          title="Frontend Development"
          icon={<AceternityIcon order="Frontend Development" />}
          des="Expert frontend web developer crafting engaging and user-friendly websites using HTML, CSS, JavaScript, React, Angular, Typescript, and Spring Boot"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Java, PHP, and MySQL backend web developer skilled in building robust and scalable applications with a focus on performance and reliability."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          icon={<AceternityIcon order="UI/UX Designing" />}
          des="I specialize in UI/UX development using Figma, Axure RP, Balsamiq, Canva & Adobe Lightroom crafting intuitive and visually appealing designs for seamless user experiences."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2] max-w-sm w-full mx-auto p-4 relative lg:h-[25rem] rounded-3xl"
      style={{
